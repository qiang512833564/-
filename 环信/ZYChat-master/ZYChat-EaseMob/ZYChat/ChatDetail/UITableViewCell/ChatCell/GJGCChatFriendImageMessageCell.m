...
@property (nonatomic, strong, readwrite)  UIImage *myImage;
@end
...
//    if (chatContentModel.isFromSelf || imageMessageBody.thumbnailDownloadStatus == EMAttachmentDownloadSuccessed) {
        ...
        NSLog(@"EMAttachmentDownloadSuccessed = %d  %@",imageMessageBody.thumbnailDownloadStatus == EMAttachmentDownloadSuccessed,imageMessageBody.thumbnailImage.localPath);
    
        UIImage *image = GJCFQuickImageByFilePath(imageMessageBody.thumbnailImage.localPath);
